...
#define RUN_P1_MS           630000UL   // 10 min 30 sec
#define RUN_P2_MS           590000UL   // 9 min 50 sec
...
void applyPumps()
{
  digitalWrite(PUMP1_PIN, pump1On() ? PUMP_ON_LEVEL : PUMP_OFF_LEVEL);
  digitalWrite(PUMP2_PIN, pump2On() ? PUMP_ON_LEVEL : PUMP_OFF_LEVEL);
}
...
void setup()
{
  ...
  digitalWrite(PUMP1_PIN, PUMP_OFF_LEVEL);
  digitalWrite(PUMP2_PIN, PUMP_OFF_LEVEL);
